...
lb = [0.1,0.1,0.1,-5,0.01, 0.001];
ub = [5,5,10,10,10,10];

% initialize particle positions & velocities
positions = lb + (ub-lb).*rand(N,6);
...
best_params_history = zeros(max_iterations, 6);
...
dy_history = best_params_history(1:iter, 6);
...
plot(1:iter, dy_history, "-m", "LineWidth", 2);
xlabel("Iteration");
ylabel("Parameter Value");
legend("k1", "k2", "tau","n", "dx", "dy");
